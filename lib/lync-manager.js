...
(function() {
  var createMeeting, edge, emitEvents, getConferenceUri, getState, joinMeeting, mute, path, references, startVideo, stopMeetings, stopVideo, unmute;

  edge = require('edge');

  path = require('path');

  references = [path.join(process.cwd(), 'assets/dlls/Microsoft.Lync.Model.dll'), path.join(process.cwd(), 'assets/dlls/Microsoft.Lync.Controls.dll'), path.join(process.cwd(), 'assets/dlls/Microsoft.Lync.Utilities.dll'), path.join(process.cwd(), 'assets/dlls/Microsoft.Lync.Controls.Resources.dll'), path.join(process.cwd(), 'assets/dlls/Microsoft.Lync.Controls.Framework.dll'), path.join(process.cwd(), 'assets/dlls/Microsoft.Lync.Controls.Framework.Resources.dll'), path.join(process.cwd(), 'assets/dlls/Microsoft.Office.Uc.dll')];
